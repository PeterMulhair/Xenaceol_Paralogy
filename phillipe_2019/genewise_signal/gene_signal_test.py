...
unix('phykit create_concatenation_matrix -a alns.txt -p philippe_CCpass', shell=True)    

unix('raxmlHPC-PTHREADS-SSE3 -s philippe_CCpass.fa -m PROTGAMMAGTR -f G -z Ttest.nwk -n philippe_CCpass_OGs -T 3', shell=True)
