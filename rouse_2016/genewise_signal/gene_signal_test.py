...
unix('phykit create_concatenation_matrix -a alns.txt -p rouse_CCpass', shell=True)    

unix('raxmlHPC-PTHREADS-SSE3 -s rouse_CCpass.fa -m PROTGAMMAGTR -f G -z Ttest.nwk -n rouse_CCpass_OGs -T 3', shell=True)
